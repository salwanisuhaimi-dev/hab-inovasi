...
$saveMultipleIdeas = function () {
    ...
    return $this->redirect(route('admin.coffb.ideas', $this->sessionId), navigate: true);
};
...
<div class="p-8 max-w-7xl mx-auto">
    <div class="mb-8 flex justify-between items-end">
        <div>
            <nav class="flex mb-4 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">
                <a href="{{ route('admin.coffb') }}" wire:navigate class="hover:text-blue-600 transition">Sesi Coff-B</a>
        ...
        <a href="{{ route('admin.coffb') }}" wire:navigate class="px-6 py-3 bg-slate-100 text-slate-600 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-slate-200 transition">
            ← Kembali
        </a>
    </div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-10">
        <div class="space-y-4">
            ...
            @include('livewire.pages.admin.partials.ideas-table', ['category' => 'inovasi', 'sessionId' => $sessionId])
        </div>
        ...
        <div class="space-y-4">
            ...
            @include('livewire.pages.admin.partials.ideas-table', ['category' => 'selain_inovasi', 'sessionId' => $sessionId])
        </div>
    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div class="md:col-span-2 flex gap-8 items-center border-b border-slate-200 pb-4">
                                    ...
                                    <label class="flex items-center gap-3 cursor-pointer group/radio">
                                        ...
                                        <span class="text-[10px] font-black uppercase tracking-widest text-slate-500">Fizikal</span>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-2 block">Tindakan / Status</label>
            ...
            <div class="flex-grow p-10 space-y-8" 
                ...
                <div class="grid grid-cols-2 gap-8 border-t border-slate-50 pt-6">
                    <div>
                        ...
                        <span class="text-xs font-black uppercase text-slate-600">{{ $selectedIdea->is_digital == 'digital' ? '⚡ Digital' : '📦 Fizikal' }}</span>
                    </div>
                    <div>
                ...
                <div>
                    <label class="text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] mb-3 block italic text-blue-600">Tindakan / Status Terkini</label>
