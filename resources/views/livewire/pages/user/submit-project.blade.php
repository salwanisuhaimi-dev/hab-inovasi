...
state([
    'program' => fn (Program $program) => $program, // program/{program}/submit
    'project_title' => '',
    'project_description' => '',
    'group_name' => '',
    'department_id' => '',
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-[2rem] border border-gray-100">
            <form wire:submit.prevent="submit" class="p-8 md:p-12 space-y-6">
                ...
                <div 
                    ...
                    <label class="block text-sm font-bold text-gray-700 mb-2 italic">Dokumen Sokongan (PDF/ZIP)</label>
                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-200 border-dashed rounded-3xl hover:border-blue-400 transition-colors">
                        <div class="space-y-1 text-center">
                            ...
                            <p class="text-xs text-gray-500 italic">PDF, DOC up to 10MB</p>
                        </div>
                    </div>

                    <div x-show="uploading" class="mt-4">
                        <div class="h-2 bg-gray-200 rounded-full overflow-hidden">
                            <div class="h-full bg-blue-600 transition-all duration-300" :style="`width: ${progress}%` text-align: center"></div>
                        </div>
                    ...
                    @if ($file_upload)
                        <div class="mt-4 p-3 bg-green-50 rounded-xl flex items-center gap-2 border border-green-100">
                            ...
                            <span class="text-xs font-bold text-green-700">Fail sedia: {{ $file_path->getClientOriginalName() }}</span>
                        </div>
                    @endif
                ...
                <div class="pt-6">
                    <button type="submit" wire:loading.attr="disabled"
                        ...
                        <span wire:loading italic>Memproses...</span>
                    </button>
                </div>
            </form>
        </div>
